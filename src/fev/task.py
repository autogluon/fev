...
class Task:
    ...
    def evaluation_summary(
        ...
        summary : dict
            ...
            - `num_forecasts` - total number of time series evaluated across all windows (accounting for multivariate targets)
        ...
        for predictions, window in zip(predictions_per_window, self.iter_windows(), strict=True):
            ...
            # Count total series: num_items * num_target_columns
